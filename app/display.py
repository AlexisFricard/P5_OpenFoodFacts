...
def display_product_from_category(id_cat):
    ...
    for id, product_name, nutriscore in cursor:
        print("|", id, "||", product_name, space *
              (67-len(product_name)), "|| Nutriscore : ", nutriscore)
...
def display_substitute_tab():

    print(substituted_msg)

    cursor.execute(query_sub_table)
