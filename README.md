...
Découper le programme en user stories puis en tâches et sous-tâches. Créer un tableau agile [**(Trello)**](https://trello.com/) et affectez des deadlines.
...
Quelles informations allons-nous enregistrer ? Quelles données allons-nous manipuler ?
...
Lister les fonctionnalités de notre programme pour s'interroger sur les responsabilités de chaque classe. Puis construire l'architecture voulue.
